    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between gap-4 mt-4">
            <div className="bg-white p-4 rounded-lg shadow-sm w-full sm:w-48 border border-purple-100">
              <p className="text-purple-600 text-sm font-medium">Total Enrolled Courses</p>
        ...
        <div className="flex border-b border-gray-200 mb-6 space-x-4">
          <button
            data-tab="available"
            className={`py-2 px-4 font-medium text-sm focus:outline-none ${activeTab === 'available'
          ...
          <button
            data-tab="enrolled"
            className={`py-2 px-4 font-medium text-sm focus:outline-none ${activeTab === 'enrolled'
                ? 'text-purple-600 border-b-2 border-purple-600'
                : 'text-gray-500 hover:text-purple-500'
              }`}
          ...
          {selectedSession && (
            <button
              ...
              className={`py-2 px-4 font-medium text-sm focus:outline-none ${activeTab === 'sessionCompletion'
                  ? 'text-purple-600 border-b-2 border-purple-600'
                  : 'text-gray-500 hover:text-purple-500'
                }`}
